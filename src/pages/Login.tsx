        ...
        <div className="max-w-[420px] w-full mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-serif font-bold text-slate-900 tracking-tight mb-2">Welcome Back</h2>
              <p className="text-slate-400 text-sm font-medium">Log in to manage your custom QR codes</p>
            </div>
